...
######### for family ##########################################################
## If any file not exist, run the corresponding scripts before plotting for S14.
## script_figure_S13.R -> Figure_S13b.txt
## get_grp_size.R -> Figure_S14.txt

dis_file <- "Figure_S7b.txt"
size_file <- "Figure_S14.txt"
...
ggsave("Figure_S14.pdf", p, height = 2.7, width = 10)
