...
######### for family, panel b #################################################
egv_folder <- "./Figure_S9/Family/accu_grp_pm_egv/Chitinophagaceae/"
...
egv_folder <- "./Figure_S9/Network_cluster/accu_grp_pm_egv/Cluster_51/"
...
######### for family, panel d #################################################
egv_folder <- "./Figure_S10/distinctive_family_egv/"
...
egv_folder <- "./Figure_S10/distinctive_netcls_egv/"
bs_files <- list.files(egv_folder, pattern = "^spectra_bs_", full.names = TRUE)
...
p <- plot_grid(p_a, p_b, p_c, p_d, nrow = 2, labels = "auto",
               align = "vb")
ggsave("Figure_S10.pdf", p, width = 10, height = 6)
